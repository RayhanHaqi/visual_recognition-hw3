...
The gradient norm (\texttt{clip\_grad\_norm\_}) could serve as a convergence indicator:
when the EMA-smoothed gradient norm stabilizes (relative change $<3\%$ over a 10-epoch window),
